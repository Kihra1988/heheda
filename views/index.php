...
<!---->
<!--            </form>-->
            <?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data'],'action'=>'/web/web/upload']) ?>
...
<div class="zong">
    ...
    <div class="container min-h" style="position: relative;">
        <div class="p-t-20 clearfix">
            <div class="pull-left">
                <button class="btn btn-dark btn-hei btn-hei-active" onclick="window.location='/web/web/index'">所有买家秀</button>
